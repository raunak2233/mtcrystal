          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] text-gray-500 md:text-xl">
                Discover the many ways crystal bracelets can enhance your
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] text-gray-500 md:text-xl">
                Get the most out of your crystal bracelets with these simple
                practices.
              </p>
            </div>
            <div className="grid gap-6 mt-8 md:grid-cols-2 lg:grid-cols-3 max-w-5xl">
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    When you first receive your crystal bracelet, hold it in
                    your hands, close your eyes, and set a clear intention for
                    what you want to achieve with it. This helps to program the
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    For maximum benefit, wear your crystal bracelet regularly.
                    The consistent contact with your skin allows the crystal's
                    energy to work with your own energy field continuously.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Crystals absorb energy, so it's important to cleanse them
                    regularly. You can do this by placing them in moonlight,
                    sunlight (for some crystals), or using methods like sound
